<template>
    <div class="example-wrap">
        <json-viewer :value="optionsShow" :expand-depth=5 copyable boxed sort theme="json-theme"></json-viewer>
        <div class="block">
            ...
            <div class="top-setting">
                ...
                <el-checkbox v-model="collapseTags" label="collapseTags--是否折叠label(仅多选有效, 默认false)" @change="handleChange"></el-checkbox>
                <el-checkbox v-model="filterable" label="filterable--是否可搜索" @change="handleChange"></el-checkbox>
                ...
                <el-radio-group v-model="expandTrigger"  @change="handleChange">
            ...
            <div class="select-value">
                <span v-for="item in selectedOptions" :key="Array.isArray(item) ? item.join(',') : item">{{item}}</span>
            </div>
            <el-multi-cascader class="multi-cascader"
            v-if="shouldReset"
            :options="options2"
            ...
            <div class="select-value">
                <span v-for="item in selectedOptions2" :key="Array.isArray(item) ? item.join(',') : item">{{item}}</span>
            </div>
        </div>
...
<style lang="less">
    .top-setting {
        .el-checkbox, .el-input, .el-radio-group{
            width: 450px;
            margin: 5px 0;
        }
    }
